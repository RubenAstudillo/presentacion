...
\subsubsection{Ejemplo intuitivo de grupo fundamental: \(\mathbb{R}^2 - \{(1,1)\}\).}
...
existe un homeomorfismo (función biyectiva continua con inversa continua)
\begin{align*}
...
\begin{proof}
  ...
  \item Que es un homomorfismo se ve por definición, puesto que se cumplen
    ...
    Del lema \ref{lema:dist-composición-producto} de composición sobre
    el producto obtenemos las siguientes igualdades
