...
\begin{definicion}
  ...
  \item \((\circ)\) corresponde a la composición de clases de
...
\(\mathscr{HoTop}_*\) debería sea el producto cartesiano de espacios.
...
Pero existe otra operación no tan conocida que puede cumplir el papel
