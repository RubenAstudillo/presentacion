...
\ref{ex:R2-11} respecto el grupo fundamental de \(\Re ^2 - \{(1,1)\}\).
\begin{corolario}
...
\begin{proof}
  ...
  \[ j \circ r : \Re ^2 - \{0\} \to \Re ^2 - \{0\} \]
  Esta composición \emph{no} es la identidad de \(\Re ^2 - \{0\}
  ...
  la identidad y \(j \circ r\) pues estos son \(\Re ^2 - \{\vec 0\}\) y
