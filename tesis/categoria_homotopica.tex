...
\emph{aplicación inclusión}; definida formalmente:
...
El teorema \ref{thm:retraccion-inclusion} también nos permite demostrar
...
\begin{definicion}[Equivalencias homotópicas] \label{def:equivalencias-hom}
...
\subsection{La categoría \(\mathscr{HoTop}_*\)}
\begin{definicion}
...
\end{definicion}
\begin{acotacion}
  %% TODO: mariela tiene otra definicion de propiedad universal
...
Podemos caracterizar más aún en el caso del producto cartesiano pues
