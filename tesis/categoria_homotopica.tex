...
\begin{lema} \label{lem:equiv-hom-lift}
  ...
  esta dado por la ecuación \(\alpha (t) = H (x_0, t)\).
\end{lema}
\noindent Aquí se utilizara la notación \(\hat \alpha\) que se utilizo
pero no definición en la demostración de el teorema \ref{not:alpha-hat}.
\begin{proof}
