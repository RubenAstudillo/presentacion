...
el elemento inicial por definicion. Lo que no es tan claro es la
presencia de un elemento terminal. Se afirma que en caso de que \((X,
x_0)\) admita un cubrimiento universal \((X_u, x_u)\) este sera el
elemento terminal.

\begin{teorema}
  Si \((X_u, x_u)\) es un cubrimiento universal de \((X, x_0)\),
  entonces \((X_u, x_u)\) es un elemento terminal de \(\mathscr{Cov} (X,
  x_0)\)
\end{teorema}
\begin{proof}
...
En vista del teorema anterior, podemos visualizar la categoria
