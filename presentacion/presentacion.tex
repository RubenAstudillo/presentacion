...
\begin{document}
  ...
  \begin{frame}
    \begin{block}{}
      \centering
      Topología Algebraica: Una visión categórica
    \end{block}
    \begin{block}{}
      \centering
  ...
  \begin{frame}
    ...
    \begin{block}{}
      Se define el conjunto \(\pi (X, x_0)\) por
      \[ \pi (X, x_0) := \{ [f] \mid f : I \to X ,\ f(0) = f(1) = x_0
        \} \] Junto con la operación
      \( [f] * [g] := [f * g]\) notando que \( g \in [f] \iff f \simeq g
      \), ie existe una homotopía entre ellos.
    \end{block}
    \begin{block}{}
  ...
  \begin{frame}
    \frametitle{Ejemplo de espacios con mismo tipo homotópico}
    \begin{block}{}
      \centering
  ...
  \begin{frame}
    \frametitle{Categoría de homotopías}
    \begin{block}{Sub categoría \(\mathscr{Top}_*\)}
  ...
  \begin{frame}
    \frametitle{Idea de demostración}
    \begin{itemize}
    \item Cubrir \(X\) con conjuntos cubiertos \(U_x\) tal que su
      preimagen por \(p\) sea una familia disjunta cuya restricción sea
      homeomorfa.
    \item Mediante preimagen de \(f\), cubrir mediante \(U_x\) a \(I\).
      ...
      intervalos que se mapeen mediante \(f\) a un único \(U_x\)
  ...
  \begin{frame}
    ...
    \begin{block}{}
      ...
      [\gamma] = [p \circ \gamma] = [k_{x_0}]\). Existe una homotopía
  ...
  \begin{frame}
    ...
    \begin{block}{Levantamiento derivado}
      ...
      homotopía entre \(\tilde \alpha, \tilde \beta\) y su proyección
      por \(p\).
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \begin{column}{0.6\textwidth}
        La función \(\phi : \pi (S^1 , x_0) \to p^{-1} (x_0)\) es
  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \begin{column}{0.6\textwidth}
        ...
        \[ p^{-1} \{[x_0]\} = \{ x_0 , - x_0\} \]
        Luego \(\pi (RP^2, x_0)\) es un grupo de dimensión 2, el cual es
        único (modulo isomorfismo) a \(\mathbb Z / 2 \mathbb Z\).
      \end{column}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}
    ...
    sobreyectivo. La versión general nos caracteriza el kernel de esta
  ...
  \begin{frame}
    ...
    es el \emph{producto libre con amalgamación}.
  \end{frame}
